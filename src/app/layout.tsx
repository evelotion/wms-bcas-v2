...
import { LayoutDashboard, Database, ArrowDownToLine, ArrowUpRightFromSquare, FileQuestion, FileText, Package2, Bell, Search, User } from "lucide-react";
        ...
        <aside className="w-64 glass-sidebar hidden md:flex flex-col relative z-30">
          ...
          <div className="h-20 flex items-center px-8 border-b border-white/50">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-black bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-indigo-600">
                GudangSync.
              </span>
            </div>
          </div>
